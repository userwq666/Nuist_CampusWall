...
### 5.2 user/post/comment status
1. `1` -> `ENABLE`
2. `0` -> `DISABLE`

### 5.3 like.target_type
1. `1` -> `POST`
2. `2` -> `COMMENT`

## 6. ER 图文件
1. Visio：`src/main/resources/sql/ER.vsdx`
2. 文档草图：可放在答辩材料中作为实体关系说明
